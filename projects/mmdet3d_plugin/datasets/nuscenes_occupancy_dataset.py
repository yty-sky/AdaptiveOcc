...
class CustomNuScenesOccDataset(NuScenesDataset):
    ...
    def __init__(self, occ_size, pc_range, build_octree, build_octree_up,
                 use_semantic=False, classes=None, overlap_test=False, *args, **kwargs):
    ...
    def prepare_train_data(self, index):
        ...
        """
        input_dict = self.get_data_info(index)  # occ_path, occ_size, pc_range, img_filename, lidar2img, cam_intrinsic, lidar2cam, ann_info
